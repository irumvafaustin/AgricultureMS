...
class InventoryController extends Controller
{
    ...
    public function addnew(Request $request){
      ...
      return redirect('/inventory')->with('success', 'New Medicine added!');;
    }
    public function addsupplies(Request $request){
      ...
      return redirect('/inventory')->with('success', 'New Suppliu Added!');
    ...
    public function addproducts(Request $request){
      ...
      return redirect('/inventory')->with('success', 'New Product added!');
    }
}
