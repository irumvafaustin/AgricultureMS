...
<head>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="{{ URL::asset('img/logo1.jpg') }}" />
    <link rel="icon" type="image/png" href="{{ URL::asset('img/logo1.jpg') }}" />
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <img src="{{ asset('img/logo1.JPG') }}" class="" alt="AMS">
            </div>
        </div>
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <strong>AGRICULTURE Management System</strong>. All Rights Reserved
                </p>
            </div>
        </footer>
