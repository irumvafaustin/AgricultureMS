            ...
            <div class="card-content">
				<ul class="list-group">
					...
					<div class="collapse" id="new">
						<li class="list-group-item action-tab add-modal1" data-type="feeds">Add New Manure</li>
...
<form action="/inventory/addnew" method="POST">
<!-- ADD MODAL FEEDS/MEDS -->
        ...
        <div class="modal-header">
          <h4 class="modal-title">Add New Item</h4>
	        ...
	        <div class="modal-body">
				...
				<div class="row">
					...
					<div class="form-group col-lg-6">
						...
						<input type="text" class="form-control" id="name_add" name="name" required autofocus>
						<p class="errorName text-center alert alert-danger hidden"></p>
					</div>

					<div class="form-group col-lg-6">
						<label for="price">Price:</label>
						<input type="text" class="form-control" id="price_add" name="price" required>
				...
				<div class="row">
					...
					<div class="form-group col-lg-4">
						...
						<input type="text" id="quantity_add" class="form-control" name="quantity" required>
						<p class="errorQuantity text-center alert alert-danger hidden"></p>
					</div>

					<div class="form-group col-lg-4">
						<label for="unit">Unit of Measurement:</label>
						<select class="form-control" id="unit_add" name="unit" required>
							<option>grams</option>
					...
					<div class="form-group col-lg-4">
						...
						<input type="text" class="form-control" id="reorder_add" name="reorder_level" required>
				...
				<div class="row">
					<div class="form-group col-lg-12">
						Remarks:
						<textarea class="form-control" id="remarks_add" rows="3" placeholder="Add any remarks to describe the action" name="added_by"></textarea>
	        ...
	        <div class="modal-footer">
				...
				<button type="submit" class="btn btn-info add-this1" >Add Medecine</button>
	        </div>
  ...
  <!-- ADD MODAL SUPPLIES -->
  <form action="/inventory/addsupplies" method="POST">
          ...
          <h4 class="modal-title">Add New Item</h4>
	        ...
	        <div class="modal-body">
				...
				<div class="row">
					...
					<div class="form-group col-lg-6">
						<label for="name">Item Name:</label>
						<input type="text" class="form-control" id="name_add1" name="name" required autofocus>
						<p class="errorName1 text-center alert alert-danger hidden"></p>
					</div>

					<div class="form-group col-lg-6">
						<label for="price">Price:</label>
						<input type="text" class="form-control" id="price_add1" name="price" required>
				...
				<div class="row">
					...
					<div class="form-group col-lg-6">
						<label for="quantity">Quantity:</label>
						<input type="text" id="quantity_add1" class="form-control" name="quantity" required>
						<p class="errorQuantity1 text-center alert alert-danger hidden"></p>
					</div>

					<div class="form-group col-lg-6">
						<label for="reorder">Reorder Level</label>
						<input type="text" class="form-control" id="reorder_add1" name="reorder_level" required>
				...
				<div class="row">
					<div class="form-group col-lg-12">
						Remarks:
						<textarea class="form-control" id="remarks_add1" rows="3" placeholder="Add any remarks to describe the action" name="added_by"></textarea>
	        ...
	        <div class="modal-footer">
	        	<button type="button" class="btn btn-default add-close" data-dismiss="modal">Close</button>
				<button type="submit" class="btn btn-info add-this2">Add Supply</button>
	        </div>
  ...
  <!-- ADD MODAL PRODUCTS -->
  <form action="/inventory/addproducts" method="POST">
          ...
          <h4 class="modal-title">Add New Item</h4>
	        ...
	        <div class="modal-body">
				...
				<div class="row">
					...
					<div class="form-group col-lg-12">
						<label for="name">Item Name:</label>
						<input type="text" class="form-control" id="name_add2" name="name" required autofocus>
				...
				<div class="row">
					...
					<div class="form-group col-lg-6">
						...
						<input type="text" class="form-control" id="wholesaleprice" name="wholesale_price" required>
				...
				<div class="row">
					...
					<div class="form-group col-lg-12">
						...
						<input type="text" id="quantity_add2" class="form-control" name="stocks" required>
				...
				<div class="row">
					<div class="form-group col-lg-12">
						Remarks:
						<textarea class="form-control" id="remarks_add2" rows="3" placeholder="Add any remarks to describe the action" name="added_by"></textarea>
	        ...
	        <div class="modal-footer">
	        	<button type="button" class="btn btn-default add-close" data-dismiss="modal">Close</button>
				<button type="submit" class="btn btn-info add-this2">Add Product</button>
	        </div>
