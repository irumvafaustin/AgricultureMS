	...
	<div class="col-lg-8">
		<div class="card">
			  <div class="card-header" data-background-color="blue">
					<h4 class="title">tomato</h4>
					<p class="category">Total number of tomato in each batch.</p>
			  </div>
	...
	<div class="col-lg-12">
		<div class="card">
			  <div class="card-header" data-background-color="blue">
					...
					<p class="category">Kg OF tomato in each batch entry.</p>
			  </div>
			  <div class="card-content table-responsive">
				<table class="table">
					<thead class="text-primary bold">
	...
	<div class="col-lg-12">
		<div class="card">
			  <div class="card-header" data-background-color="blue">
					...
					<p class="category">Kg of tomato from each batch.</p>
			  </div>
			  <div class="card-content table-responsive">
				<table class="table">
					<thead class="text-primary bold">
