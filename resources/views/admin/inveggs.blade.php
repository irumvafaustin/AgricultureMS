	...
	<div class="col-lg-8">
		<div class="card">
			  <div class="card-header" data-background-color="blue">
					<h4 class="title">carroti Batches</h4>
					<p class="category">Kg of carroti each fresh batch entry.</p>
			  </div>
...
<div class="row">
	<div class="col-lg-6 col-md-12">
		<div class="card">
			  <div class="card-header" data-background-color="blue">
					<h4 class="title">Reject carroti</h4>
					<p class="category">Kg of carroti from different batches.</p>
			  </div>
	...
	<div class="col-lg-6 col-md-12">
		<div class="card">
			  <div class="card-header" data-background-color="blue">
					<h4 class="title">experied </h4>
					<p class="category">kG of carroti experied from different batches.</p>
			  </div>
			  <div class="card-content table-responsive">
				<table class="table">
					<thead class="text-primary bold">
				...
				<div class="row">
					...
					<div class="form-group col-lg-9">
						...
						<select class="form-control" id="remarks_add">
							...
							<option>Returned carroti</option>
