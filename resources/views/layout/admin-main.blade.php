...
<head>
    ...
    <title>AGRICULTURE MANAGEMENT SYSTEM - @yield ('title')</title>
        ...
        You can also add an image using data-image tag -->
            ...
            <div class="logo" style="background-color: black;">
                <a href="/admin" class="simple-text" style="color:white">
                    AGRICULTURE <br> Management System
                </a>
                <hr class="br-2">
            </div>
           ...
           <nav class="navbar navbar-transparent navbar-absolute" style="background-color:blue">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand page-title" href="#" style="color:white"> @yield ('title') </a>
                    </div>
                    <div class="collapse navbar-collapse navbar-form" style="color:white">
            ...
            <footer class="footer">
                ...
                <div class="container-fluid">
                    ...
                    <p class="copyright pull-right">
                        ...
                        <a href="#"><strong>AGRICULTURE Management System </strong>. All Rights Reserved
                    </p>
                </div>
            </footer>
        </div>
