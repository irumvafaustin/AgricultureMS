...
/// add new medecine
Route::post('/inventory/addnew','InventoryController@addnew');
/// add new supplier
Route::post('/inventory/addsupplies','InventoryController@addsupplies');

// add new product
Route::post('/inventory/addproducts','InventoryController@addproducts');
